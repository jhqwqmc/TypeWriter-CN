...
This guide assumes that you have already installed the Road Network Extension.\
...
In the `Base Road Network` entry in the inspector, click the <ActionButton button='capture'/> icon next to the ArtifactId field to open the content mode.
