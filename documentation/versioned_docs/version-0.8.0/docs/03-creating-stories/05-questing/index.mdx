...
:::
:::danger[Writers Note]
The questing section on our docs is currently being rewritten. If you want the old documentation that is complete read: [**Old Quest Documentation**](../../../../version-0.7.0/docs/03-creating-stories/05-questing/index.mdx)
:::
