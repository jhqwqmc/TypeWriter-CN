 ...
 * This could be used to create a pillager entity.
 */
class PillagerDefinition(
...
class PillagerInstance(
    override val id: String = "",
    override val name: String = "",
    override val definition: Ref<PillagerDefinition> = emptyRef(),
...
private class PillagerEntity(player: Player) : WrapperFakeEntity(
