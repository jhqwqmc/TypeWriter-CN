...
:::warning[Option]
If you are using the option from the [waiting for interaction](#waiting-for-interaction), you need to configure the following steps in the option and **NOT** inside the start cinematic.  
:::
